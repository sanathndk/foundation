...
if(strlen($_SESSION['alogin'])=="")
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form lign-items-center d-flex" method="get" action="usersearch.php">        
      ...
      <ul class="d-flex align-items-center">       
        ...
        <li class="nav-item pe-3">       
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="userprofile.php?id=<?php echo $_SESSION['user_id']; ?>">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="usercontact.php">
